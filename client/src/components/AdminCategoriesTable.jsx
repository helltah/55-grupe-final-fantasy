                    ...
                    <div className="table-responsive">
                        <table className="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">2</th>
                                    <td><Link to="/admin/categories/animation">Animation</Link></td>
                                    <td>animation</td>
                                    <td>Animation</td>
                                    <td>0</td>
                                    <td><span className="badge text-bg-success">Published</span></td>
                                    <td className="d-flex gap-3">
                                        <Link className="btn btn-primary btn-sm" to="/admin/categories/animation/edit">Edit</Link>
                                        <button data-url="animation" className="btn btn-danger btn-sm">Delete</button>
                                    </td>
                                </tr>          
                            </tbody>
                        </table>
